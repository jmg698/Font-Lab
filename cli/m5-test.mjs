...
try {
  ...
  try {
    ...
    for (const t of ["font_lab_analyze", "font_lab_list_catalog", "font_lab_curate", "font_lab_compose_directions", "font_lab_prepare_preview", "font_lab_read_pick", "font_lab_apply", "font_lab_undo"])
